...
5. **Phase 5 — Test + ship.** Full E2E suite, Firefox parity verification, store listing artifacts. *Exit criteria: nightly green, both browsers verified, listing copy reviewed for the "no implication of officialness" branding rule.*

...
5. **Phase 5 — Ship.** Firefox parity verification, store listing artifacts (icons, screenshots, copy). *Exit criteria: both browsers verified end-to-end against a real account, listing copy reviewed for the "no implication of officialness" branding rule, store listings ready to submit.*
